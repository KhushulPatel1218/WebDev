...
/**
  ...
  * @param object $conn Connection to the database
  *
  * @return boolean True of the update was successful, false otherwise
  */
...
*/
  ...
  *
  * @param object $conn Connectionto the database
  *
  ...
  */
  ...
  /**
  * Insert a new article with its current property
  *
  * @param object $conn Connection  to the database
  *
